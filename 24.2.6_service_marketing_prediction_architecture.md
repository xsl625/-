...
graph TB
    subgraph "展现层 Presentation Layer"
        A[预测分析控制台<br/>Prediction Analytics Console]
        B[营销策略工作台<br/>Marketing Strategy Workbench]
        C[效果评估仪表板<br/>Effect Evaluation Dashboard]
        D[移动端预测应用<br/>Mobile Prediction App]
    end
